      ...
      <ul class="navbar-nav">
          ...
          <?php if(!isset($_SESSION['verified_user_id'])) :  ?>
            ...
            <li class="nav-item">
              ...
              <a class="dropdown-item" href="elogin.php">as Alumni Seeker</a>
            </div>
            ...
            <li class="nav-item">
              ...
              <a type="button" class="btn btn-outline-light ml-1 mr-2" href="EmployerRegistration.php">Alumni Seeker</a>
            </li>
            <form class="d-flex">
          ...
          <?php else :  ?>
            ...
            ?>
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="AlumniMainProfile.php">My Profile</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="home.php">Dashboard</a>
                  <a class="dropdown-item" href="AlumniJobHiring.php">Job Search</a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="list-group">
                                                  <a href="AlumniEditInfo.php" class="list-group-item list-group-item-action list-group-item-success text-center">Edit Personal Information</a>
                                                  <a href="AlumniEditEduWork.php" class="list-group-item list-group-item-action list-group-item-success text-center">Edit Work and Education</a>
                                                  <a href="AlumniSecurity.php" class="list-group-item list-group-item-action list-group-item-success text-center">Edit Security</a>
                                                </div>
                                                </div>

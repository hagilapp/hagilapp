                        ...
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-primary mt-1 px-sm-4" type="submit" name="updatePIC">Save Photo</button>
                                </div>
                            </div>
            ...
            <div class="col-md-8 mt-1">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                ...
                                <select name="nationality" id="status" class="form-control" required>
                                    <option value="" disabled selected>Select your Nationality</option>
                                    <option value='Filipino'>Filipino</option>
                                    <option value='other'>Others</option>
                                </select>
                                <label for="input"  id="inputLabel" style="display: none">Please specify:
                                    <input type="text" name="otherNat" class="form-control" id="input">
                                </label>
                                </div>
                            </div>
                        </div><hr>
                ...
                <div class="card row mt-3">
                    <div class="card-body">
                        ...
                        <?php 
                                ...
                                $getData = $database->getReference("AUserList/$uid/Education")->getValue();
                ...
                <div class="card row mt-3">
                    <div class="card-body">
                        ...
                        <?php 
                                include('src/firebasePHP.php');
                                $getData = $database->getReference("AUserList/$uid/Work")->getValue();
